...
export default function Home() {
  return (
<div>
    <div className="flex sm:m-5 md:m-5 items-center justify-center h-screen">
        <div className="h-[500px] sm:h-[400px] w-[1000px] border-2 border-zinc-600 border-opacity-60 rounded-[50px] glow-animation">
        <img src="https://cdn.discordapp.com/attachments/1284170761317126236/1284170876568473692/banner.png?ex=670b3b93&is=6709ea13&hm=114125cbc849b4efbdc7d2fdaf9ef8f7a225b39229745fe4f0cc0ea620439388&" alt="GDGLogo" className="w-full sm:h-[40%] h-[70%] rounded-tl-[50px] rounded-tr-[50px]  "/>
